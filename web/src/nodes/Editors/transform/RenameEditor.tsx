...
const RenameEditor: React.FC<RenameEditorProps> = ({
        ...
        {hasUpstreamColumns ? (
          <>
            ...
            <div className="border border-border rounded-lg overflow-hidden">
              {/* Header */}
              <div className="grid grid-cols-[1fr_auto_1fr] gap-2 px-4 py-3 bg-surface-secondary border-b border-border">
              ...
              <div className="divide-y divide-border">
                {availableColumns.map((columnName) => {
                  ...
                  return (
                    <div
                      key={columnName}
                      className="grid grid-cols-[1fr_auto_1fr] gap-2 px-4 py-3 items-center hover:bg-surface-secondary/50 transition-colors"
                    >
                      {/* Original column name */}
                      <div className="flex items-center">
                        <code className="text-sm font-mono text-text-primary bg-surface-secondary px-2 py-1 rounded">
                          {columnName}
                        </code>
                      </div>
                      ...
                      <div className="flex items-center justify-center px-2">
                        <ArrowRight
                          size={16}
                          className={newName.trim() ? 'text-primary' : 'text-text-tertiary'}
                        />
                      </div>
  ...
  return (
    <BaseEditorWrapper
      ...
      icon={<Replace size={28} className="text-purple-500" />}
      onClose={handleClose}
