...
const UnifyEditor: React.FC<UnifyEditorProps> = ({
 ...
 <div className="flex items-center justify-between rounded-lg border border-line-1 bg-bg-page px-4 py-3">
 <div>
 <p className="text-sm font-medium text-text-1">Include calculated metrics</p>
 ...
 <div className="px-4 py-3 bg-bg-card border-b border-line-1">
 <p className="text-sm font-medium text-text-2">Field Mapping Preview</p>
 </div>

 {/* Table header */}
 <div className="grid grid-cols-[1fr_32px_1fr] gap-2 px-4 py-2 bg-bg-card/50 border-b border-line-1">
 <span className="text-xs font-medium text-text-3">Source Field</span>
 <span />
 <span className="text-xs font-medium text-text-3">Unified Field</span>
 </div>
 ...
 className="grid grid-cols-[1fr_32px_1fr] gap-2 px-4 py-2.5 items-center hover:bg-bg-card/50 transition-colors"
 >
 <code
 className={`text-sm font-mono px-2 py-1 rounded truncate ${
 isCalculated
 ? 'text-text-3 bg-bg-card italic'
 ...
 <code className="text-sm font-mono px-2 py-1 rounded text-blue-primary bg-blue-soft truncate">
 {mapping.unified}
 </code>
 </div>
 );
 ...
 {/* Summary footer */}
 <div className="px-4 py-2.5 bg-bg-card border-t border-line-1">
 ...
 {!platform && (
 <div className="text-center py-8 border border-line-1 border-dashed rounded-lg">
 <Layers size={32} className="mx-auto mb-3 text-text-3" />
 ...
 <BaseEditorWrapper
 title="Unify Schema"
 icon={<Layers size={28} className="text-violet" />}
 onClose={handleClose}
