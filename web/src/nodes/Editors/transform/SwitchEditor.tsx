...
const SwitchEditor: React.FC<SwitchEditorProps> = ({
 ...
 <label className="text-xs font-medium text-text-2">Switch on field</label>
 ...
 {/* Cases */}
 <div className="flex flex-col gap-1.5">
 <label className="text-xs font-medium text-text-2">Cases</label>
 ...
 >
 {/* Case label */}
 <span className="text-[10px] font-mono text-text-3 flex-shrink-0 w-14 truncate">
 {c.case_id}
 </span>
 ...
 <div className="flex items-center gap-2 p-2.5 rounded-xl bg-bg-card/50 border border-dashed border-line-1">
 <span className="text-[10px] font-mono text-text-3 flex-shrink-0 w-14">
 default
 </span>
 <span className="flex-1 text-xs text-text-3 italic">
