...
const ColumnEditorEditor: React.FC<ColumnEditorEditorProps> = ({
 ...
 {/* Header */}
 <div className="grid grid-cols-[1fr_1fr_130px_36px] gap-2 px-4 py-3 bg-bg-card border-b border-line-1">
 <span className="text-sm font-medium text-text-2">
 Original Column
 </span>
 <span className="text-sm font-medium text-text-2">New Name</span>
 <span className="text-sm font-medium text-text-2">Data Type</span>
 <span className="text-sm font-medium text-text-2 text-center">Drop</span>
 </div>
 ...
 disabled={isDropped}
 className={`w-full h-9 px-2 text-sm rounded-md border border-line-1 bg-bg-page focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent ${
 isDropped
 ? 'opacity-50 cursor-not-allowed'
 : hasSelectedCast
 ? 'text-text-1'
 ...
 : 'text-text-3 hover:text-red-500 hover:bg-red-950/30'
 }`}
 ...
 <div className="border border-line-1 rounded-lg overflow-hidden">
 <div className="flex items-center justify-between px-4 py-3 bg-bg-card border-b border-line-1">
 <span className="text-sm font-medium text-text-2">Add New Columns</span>
 <button
 type="button"
 onClick={handleAddNewColumn}
 className="flex items-center gap-1 text-sm text-blue-primary hover:text-blue-primary"
 >
 <Plus size={14} />
 Add Column
 </button>
 ...
 <div className="divide-y divide-border">
 {/* New columns header */}
 <div className="grid grid-cols-[1fr_1fr_130px_36px] gap-2 px-4 py-2 bg-bg-card/50">
 <span className="text-xs font-medium text-text-3">Column Name</span>
 <span className="text-xs font-medium text-text-3">Value</span>
 <span className="text-xs font-medium text-text-3">Data Type</span>
 <span className="text-xs font-medium text-text-3 text-center"></span>
 </div>
 {newColumns.map((nc) => {
 ...
 className={`text-sm ${
 isIncomplete && touched && 'border-danger-border focus:border-danger-border focus:ring-error/20'
 }`}
 />
 </div>
 ...
 className="w-full h-9 px-2 text-sm rounded-md border border-line-1 bg-bg-page text-text-1 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
 >
 {DATA_TYPES.map((type) => (
 ...
 className="w-7 h-7 rounded-md flex items-center justify-center text-text-3 hover:text-red-500 hover:bg-red-950/30 transition-colors"
 title="Remove column"
 >
 <Trash2 size={14} />
 </button>
 ...
 <div className="px-4 py-4 text-center text-sm text-text-3">
 ...
 <BaseEditorWrapper
 title="Column Editor"
 icon={<Columns3 size={28} className="text-violet" />}
 onClose={handleClose}
