    ...
    <div className="max-w-4xl mx-auto space-y-8">
        ...
        >
          <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-3">
            ...
            <div className="flex-shrink-0">
              <a 
                ...
                className="flex items-center justify-center gap-1 px-3 py-2 text-sm text-brand-600 hover:text-brand-700 hover:bg-brand-50 rounded-lg transition-colors border border-brand-200 whitespace-nowrap h-10"
          ...
          {formData.connection_id && (
            <div className="mt-2">
              <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-success/10 text-success text-xs font-medium w-fit">
        ...
        {formData.connection_id && (
          ...
          >
            <div className="p-4 rounded-lg bg-surface-secondary/50 border border-border-primary">
              <BigQuerySelector
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <div className="p-3 rounded-lg bg-surface-secondary/50 border border-border-primary">
