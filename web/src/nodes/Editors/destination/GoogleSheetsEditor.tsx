...
const GoogleSheetsEditor: React.FC<GoogleSheetsEditorProps> = ({ data, onChange, onClose, onValidate, compact = false }) => {
  ...
  const formContent = (
    <div className="space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-3">
            ...
            <div className="flex-shrink-0">
              <a 
                ...
                className="flex items-center justify-center gap-1 px-3 py-2 text-sm text-brand-600 hover:text-brand-700 hover:bg-brand-50 rounded-lg transition-colors border border-brand-200 dark:border-brand-700 dark:hover:bg-brand-500/10 whitespace-nowrap h-10"
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="space-y-4">
            ...
            {formData.spreadsheet_id && spreadsheets.length > 0 && (
              <div className="text-xs text-text-secondary bg-surface-secondary/50 rounded-md p-3 border border-border-primary">
                <div className="font-medium text-text-primary">Selected Spreadsheet:</div>
                <div className="mt-1">
                  {(() => {
        ...
        {/* Data Configuration */}
        <div className="space-y-3 sm:space-y-4">
          <div className="flex items-center gap-2 sm:gap-3 pb-2 sm:pb-3 border-b border-border-primary">
            <div className="p-2 rounded-lg bg-warning/10 text-warning">
              <Settings className="w-4 h-4" />
            </div>
            <div>
              <h3 className="text-sm font-semibold text-text-primary">Data Configuration</h3>
              <p className="text-xs text-text-secondary">Configure how data should be written to the sheet</p>
            </div>
          </div>
          ...
          <Input
            ...
            <div className="bg-surface-secondary/50 rounded-lg p-3 border border-border-primary">
              <p className="text-xs font-medium text-text-secondary mb-2">Range Examples:</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-text-tertiary">
                <button 
                  type="button"
                  onClick={() => handleChange({ range: 'A1:Z' })}
                  className="text-left hover:text-brand-600 hover:bg-brand-50 px-2 py-1 rounded transition-colors"
                >
                  <code className="bg-surface-tertiary px-1 rounded border border-border-primary">A1:Z</code> - Columns A to Z
                </button>
                <button 
                  type="button"
                  ...
                  className="text-left hover:text-brand-600 hover:bg-brand-50 px-2 py-1 rounded transition-colors"
                >
                  <code className="bg-surface-tertiary px-1 rounded border border-border-primary">A1:C100</code> - Specific range
                </button>
                <button 
                  type="button"
                  ...
                  className="text-left hover:text-brand-600 hover:bg-brand-50 px-2 py-1 rounded transition-colors"
                >
                  <code className="bg-surface-tertiary px-1 rounded border border-border-primary">Data!A1:Z</code> - Named sheet
                </button>
                <button 
                  type="button"
                  ...
                  className="text-left hover:text-brand-600 hover:bg-brand-50 px-2 py-1 rounded transition-colors"
                >
                  <code className="bg-surface-tertiary px-1 rounded border border-border-primary">Empty</code> - Entire sheet
                </button>
              </div>
            </div>
          </div>
