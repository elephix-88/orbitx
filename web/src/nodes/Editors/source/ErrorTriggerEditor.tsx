      ...
      <div className="bg-surface-secondary/30 border border-border-primary rounded-xl p-4 space-y-3">
        ...
        <div className="space-y-2">
          {PAYLOAD_FIELDS.map((field) => (
            <div
              key={field.key}
              className="flex items-start gap-3 rounded-lg border border-border-primary bg-surface-primary px-3 py-2.5"
            >
              <div className="min-w-0 flex-1">
                <p className="text-xs font-medium text-text-primary font-mono">{field.key}</p>
