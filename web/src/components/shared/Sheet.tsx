...
const sheetVariants = cva(
 [
 'fixed z-50 gap-4 bg-bg-card shadow-md',
 ...
 variants: {
 side: {
 top: 'inset-x-0 top-0 border-b border-line-1',
 bottom: 'inset-x-0 bottom-0 border-t border-line-1',
 left: 'inset-y-0 left-0 h-full border-r border-line-1',
 right: 'inset-y-0 right-0 h-full border-l border-line-1',
 },
 size: {
 sm: '',
 default: '',
...
export const Sheet = ({
 ...
 >
 {/* Header */}
 <div className="flex flex-col space-y-2 p-6 border-b border-line-1">
 ...
 "text-neutral-500 hover:text-neutral-200 hover:bg-bg-muted",
 ...
 {/* Footer */}
 {footer && (
 <div className="flex flex-col-reverse gap-2 p-6 border-t border-line-1 sm:flex-row sm:justify-end">
 {footer}
 </div>
 )}
 </div>
...
export const SheetTitle: React.FC<{
 ...
 <h2 className={cn("text-lg font-semibold text-text-1", className)}>
 {children}
 </h2>
);
