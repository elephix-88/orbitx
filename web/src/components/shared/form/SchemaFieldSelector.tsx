...
export function SchemaFieldSelector({
 ...
 {/* Search Bar */}
 <div className="sticky top-0 z-10 bg-bg-page/95 backdrop-blur-sm pb-2">
 ...
 className="w-full pl-10 pr-10 py-2.5 rounded-lg bg-bg-card border border-line-1 focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-blue-primary text-text-1 placeholder:text-text-3 transition-all text-sm"
 />
 {searchTerm && (
 <button
 type="button"
 ...
 <div className="bg-bg-card/30 border border-line-1 rounded-lg overflow-hidden">
 {groupNames.length === 0 ? (
 ...
 className={cn(
 "w-full px-3 py-2.5 flex items-center justify-between hover:bg-bg-card/50 transition-colors",
 groupIndex > 0 && "border-t border-line-1/50"
 )}
 >
 ...
 : "text-blue-primary hover:bg-blue-soft"
 )}
 >
 ...
 <div className={cn(
 hasGroups && "border-t border-line-1/30"
 )}>
 ...
 key={field.id}
 className={cn(
 "flex items-center gap-3 px-3 py-2 cursor-pointer transition-colors border-b border-line-1/20 last:border-b-0",
 isSelected
 ? "bg-blue-primary/5 hover:bg-blue-soft"
 : "hover:bg-bg-card/50"
 )}
 >
 <div className={cn(
 ...
 <span className={cn(
 "text-sm truncate",
 isSelected ? "text-blue-primary font-medium" : "text-text-1"
 )}>
 {field.label}
 </span>
