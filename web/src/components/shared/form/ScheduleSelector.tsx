...
export const ScheduleSelector: React.FC<ScheduleSelectorProps> = ({
 ...
 <div>
 <label className="block text-sm font-semibold text-text-1 mb-2.5">
 Schedule Frequency
 </label>
 <Select
 ...
 <p className="mt-1.5 text-xs text-text-3 font-mono">
 ...
 <div className="rounded-xl border border-blue-border bg-blue-soft overflow-hidden">
 {/* Description */}
 <div className="p-4 border-b border-blue-primary/10">
 <div className="flex items-start space-x-3">
 <div className="text-blue-primary mt-0.5">
 <Clock className="w-5 h-5" />
 </div>
 <div className="flex-1">
 <p className="text-sm font-bold text-text-1 mb-1">
 ...
 {/* Next run times */}
 {nextRuns.length > 0 && (
 <div className="p-4 bg-bg-page/30">
 <div className="flex items-start space-x-3">
 <div className="text-success mt-0.5">
 <Calendar className="w-5 h-5" />
 </div>
 <div className="flex-1">
 <p className="text-sm font-bold text-text-1 mb-2">
 Next Run Times
 </p>
 <ul className="space-y-1.5">
 {nextRuns.map((run, idx) => (
 <li key={idx} className="text-sm text-text-2 flex items-center">
 <span className="w-5 h-5 flex items-center justify-center rounded-full bg-success-bg text-success text-xs font-medium mr-2">
 {idx + 1}
 </span>
 {formatNextRun(run)}
 </li>
