  ...
  return (
    <div
      className={cn(
        ...
        data.debugSucceeded && !data.debugFailed && 'border-success/60',
      )}
      onDoubleClick={(e) => {
        e.stopPropagation();
        if (isInDebugMode) {
    ...
    >
      ...
      >
        ...
        {isInDebugMode && data.debugRowCount !== undefined && !data.debugFailed && (
          <span className="flex-shrink-0 text-[9px] font-medium px-1 py-0.5 rounded-md bg-success/20 text-success border border-success/30">
