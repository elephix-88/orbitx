...
export const TemplateSelector: React.FC<TemplateSelectorProps> = ({
 ...
 {/* Modal */}
 <div className="relative bg-bg-page rounded-2xl shadow-2xl max-w-4xl w-full mx-4 max-h-[85vh] overflow-hidden animate-in zoom-in-95 duration-200">
 {/* Header */}
 <div className="flex items-center justify-between px-6 py-4 border-b border-line-1">
 <div className="flex items-center gap-3">
 <div className="p-2 rounded-xl bg-blue-primary/10">
 ...
 <div className="w-full md:w-2/5 flex flex-col h-1/2 md:h-full border-b md:border-b-0 border-line-1">
 {/* Search & Filter */}
 ...
 className="w-full pl-10 pr-4 py-2 text-sm rounded-lg bg-bg-card border-0 text-text-1 placeholder:text-text-3 focus:ring-2 focus:ring-blue-soft"
 />
 </div>
 ...
 : 'hover:bg-bg-card border-2 border-transparent'
 )}
 >
 ...
 <h4 className="font-medium text-text-1 text-sm truncate">
 {template.name}
 </h4>
 {isSelected && (
 <CheckCircle className="w-4 h-4 text-blue-primary flex-shrink-0" />
 )}
 </div>
 <p className="text-xs text-text-2 mt-0.5 line-clamp-2">
 ...
 <div className="text-xs text-text-2 mb-2">Sources</div>
 <div className="flex flex-wrap gap-2">
 {selectedTemplate.sources.map((source) => (
 <span
 key={source}
 className="px-2.5 py-1 text-xs font-medium bg-blue-soft text-blue-primary rounded-lg"
 >
 {source}
 </span>
 ))}
 ...
 {/* Destinations */}
 <div className="flex-1">
 <div className="text-xs text-text-2 mb-2">Destinations</div>
 <div className="flex flex-wrap gap-2">
 {selectedTemplate.destinations.map((dest) => (
 <span
 key={dest}
 className="px-2.5 py-1 text-xs font-medium bg-success-bg text-success rounded-lg"
 >
 {dest}
 </span>
 ))}
 ...
 >
 <span className="flex-shrink-0 w-5 h-5 rounded-full bg-blue-primary/15 text-blue-primary text-xs flex items-center justify-center mt-0.5">
 {index + 1}
 </span>
 {tip}
 </li>
 ...
 {/* Action Footer */}
 <div className="p-4 border-t border-line-1 bg-bg-card">
 <button
 onClick={handleSelectTemplate}
 className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-blue-primary hover:bg-blue-primary-hover text-white font-medium rounded-xl transition-colors"
 >
 Use This Template
 ...
 <Workflow className="w-8 h-8 text-text-3" />
 </div>
