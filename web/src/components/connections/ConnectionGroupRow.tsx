...
export const ConnectionGroupRow: React.FC<ConnectionGroupRowProps> = ({
 ...
 return (
 <div className="rounded-lg border border-line-1 overflow-hidden bg-bg-card/10">
 {/* Group Header */}
 <button
 ...
 'hover:bg-bg-card/40',
 isExpanded && 'border-b border-line-1'
 )}
 >
 {/* Expand Icon */}
 <motion.div
 ...
 <span className="text-sm text-text-1 font-medium truncate block">
 ...
 className="flex-shrink-0 px-3 py-1.5 text-xs font-medium text-text-2 hover:text-text-1 bg-bg-card/50 hover:bg-bg-card border border-line-1 rounded-md transition-colors"
 >
 View Details
 </motion.button>
 ...
 'hover:bg-bg-card',
 openMenuId === connection.id && 'bg-bg-card text-text-1'
 )}
 >
 ...
 className="absolute right-0 top-full mt-1 w-36 py-1 bg-bg-page border border-line-1 rounded-lg shadow-lg z-50"
 >
 <button
 onClick={(e) => {
 e.stopPropagation();
