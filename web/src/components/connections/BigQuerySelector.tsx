    ...
    <div className="space-y-6">
      <FormGrid cols={2}>
        ...
        <div className="space-y-3">
          ...
          {projectsError && (
            <div className="text-sm text-error bg-error-light p-3 rounded-lg border border-error/20 mb-3">
              {projectsError}
            </div>
          )}
      ...
      {/* Dataset Info */}
      {selectedDataset && (
        <div className="bg-surface-secondary/50 p-4 rounded-lg border border-primary/10">
          {(() => {
