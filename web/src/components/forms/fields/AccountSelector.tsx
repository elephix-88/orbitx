...
export const AccountSelector: React.FC<AccountSelectorProps> = ({
 ...
 <div className="flex items-center gap-2 text-sm text-text-3 py-3">
 ...
 <div className="flex items-center gap-2 p-3 bg-bg-card border border-line-1 rounded-xl text-sm text-text-3">
 ...
 disabled={disabled}
 className="text-xs text-blue-primary hover:text-blue-primary font-medium disabled:opacity-50"
 >
 ...
 {autoSelected && (
 <p className="mt-1 text-xs text-blue-primary">Auto-selected the only available account</p>
 )}
 {displayError && (
