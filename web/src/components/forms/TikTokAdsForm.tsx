...
export const TikTokAdsForm: React.FC<TikTokAdsFormProps> = ({
 ...
 <label className="text-xs font-medium text-text-2">TikTok Connection</label>
 <a
 href="/connections"
 ...
 ? "border-blue-primary ring-2 ring-brand-500/20"
 ...
 conn.id === formData.connection_id && "bg-blue-primary/5"
 )}
 >
 ...
 isSelected ? "bg-blue-primary/5" : "hover:bg-bg-card/50"
 )}
 >
 <div
 className={cn(
 ...
 <div className="text-sm text-text-1 truncate">{account.advertiser_name}</div>
 <div className="text-xs text-text-3">{account.advertiser_id}</div>
 </div>
 <input
 type="checkbox"
 className="hidden"
 ...
 className={cn(
 "w-full px-3 py-2.5 text-left text-sm flex items-center justify-between hover:bg-bg-card transition-colors",
 preset.value === formData.time_config?.time_preset && "bg-blue-primary/5"
 )}
 >
 ...
 <span className="text-text-1 font-medium">{formData.ad_account_id.length}</span>
 </div>
 <div className="w-px h-4 bg-border-primary" />
 <div className="flex items-center gap-2">
 <span className="text-text-3">Fields:</span>
 <span className="text-text-1 font-medium">{formData.fields.length}</span>
 </div>
 </div>
 <div className="flex items-center gap-2">
