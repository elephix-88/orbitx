    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="bg-surface-primary border border-border-primary rounded-xl shadow-2xl overflow-hidden"
        >
            ...
            <div className="mt-3 pt-3 border-t border-border-primary flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-3 py-1 text-xs text-text-secondary hover:text-text-primary hover:bg-surface-secondary rounded-md transition-colors"
                >
                  Clear
                </button>
                <button
                  ...
                  className="px-3 py-1 text-xs bg-brand-500 text-white hover:bg-brand-600 rounded-md transition-colors"
                >
                  Done
                </button>
              </div>
        ...
        className={cn(
          ...
          error
            ...
            : isOpen
              ...
              : "border-border-primary bg-surface-primary hover:border-brand-500/50"
        )}
      >
        <Calendar className={cn("text-text-tertiary", compact ? "w-3 h-3" : "w-3.5 h-3.5")} />
        <span className={cn(
          "font-medium",
          range?.from && range?.to ? "text-text-primary" : "text-text-tertiary"
        )}>
          {displayText}
        </span>
        {daysDiff > 0 && (
