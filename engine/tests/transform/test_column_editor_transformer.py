...
class TestColumnEditorTransformer:
    ...
    @pytest.mark.asyncio
    async def test_rename_only(self):
    ...
    @pytest.mark.asyncio
    async def test_rename_and_cast(self):
    ...
    @pytest.mark.asyncio
    async def test_empty_conversions_passthrough(self):
    ...
    @pytest.mark.asyncio
    async def test_duplicate_rename_raises_error(self):
    ...
    @pytest.mark.asyncio
    async def test_cast_string_to_integer(self):
    ...
    @pytest.mark.asyncio
    async def test_cast_to_boolean(self):
    ...
    @pytest.mark.asyncio
    async def test_cast_to_date(self):
    ...
    @pytest.mark.asyncio
    async def test_cast_to_datetime(self):
    ...
    @pytest.mark.asyncio
    async def test_preserves_unmodified_columns(self):
    ...
    @pytest.mark.asyncio
    async def test_try_cast_handles_invalid_values(self):
    ...
    @pytest.mark.asyncio
    async def test_drop_and_rename_combined(self):
    ...
    @pytest.mark.asyncio
    async def test_drop_and_cast_combined(self):
    ...
    @pytest.mark.asyncio
    async def test_drop_preserves_row_count(self):
    ...
    @pytest.mark.asyncio
    async def test_add_single_new_column(self):
    ...
    @pytest.mark.asyncio
    async def test_add_multiple_new_columns(self):
    ...
    @pytest.mark.asyncio
    async def test_add_new_column_with_float_type(self):
    ...
    @pytest.mark.asyncio
    async def test_add_new_column_with_boolean_type(self):
    ...
    @pytest.mark.asyncio
    async def test_add_new_column_combined_with_conversions(self):
    ...
    @pytest.mark.asyncio
    async def test_add_new_column_with_drop(self):
    ...
    @pytest.mark.asyncio
    async def test_duplicate_new_column_name_raises_error(self):
    ...
    @pytest.mark.asyncio
    async def test_new_column_conflicts_with_existing(self):
    ...
    @pytest.mark.asyncio
    async def test_new_column_with_special_characters(self):
    ...
    @pytest.mark.asyncio
    async def test_only_new_columns_no_conversions(self):
    ...
    @pytest.mark.asyncio
    async def test_empty_dataframe_with_new_column(self):
