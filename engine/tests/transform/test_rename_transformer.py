...
class TestRenameTransformer:
    ...
    def test_duplicate_target_name_raises_error(self):
    ...
    def test_swap_columns_raises_error(self):
    ...
    def test_multiple_missing_columns_error_message(self):
    ...
    def test_error_includes_missing_column_name(self):
